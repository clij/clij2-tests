...
public class ResliceBottomTest {
    ...
    public void resliceBottom() throws InterruptedException {
        ...
        ClearCLImage outputCL = clij2.create(new long[]{inputCL.getWidth(), inputCL.getDepth(), inputCL.getHeight()}, inputCL.getChannelDataType());

        clij2.resliceBottom(inputCL, outputCL);
    ...
    public void resliceBottom_Buffers() throws InterruptedException {
        ...
        ClearCLBuffer outputCL = clij2.create(new long[]{inputCL.getWidth(), inputCL.getDepth(), inputCL.getHeight()}, inputCL.getNativeType());
